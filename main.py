...
class ResQSwarm:
    ...
    def __init__(self, qwen_client: QwenClient):
        self.log_analyzer = LogAnalyzer(qwen_client)
    ...
    async def handle_incident(self, incident_data: dict) -> dict:
        ...
        Args:
            incident_data: Dict with 'logs' and 'metrics' keys
...
async def main():
    ...
    parser.add_argument("--incident", type=str, help="Path to incident JSON file")
